...
class ServiceDefaults {
  ...
  ServiceDefaults.fromJson(Map<String, dynamic> json) {
    total = json['Total'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['ServiceStateList'] != null) {
      serviceStateList = new List<ServiceStateList>();
      json['ServiceStateList'].forEach((v) {
        serviceStateList.add(new ServiceStateList.fromJson(v));
      });
    }
    ...
    if (json['ServiceList'] != null) {
      serviceList = new List<ServiceListDef>();
      json['ServiceList'].forEach((v) {
        serviceList.add(new ServiceListDef.fromJson(v));
      });
    }
  }
...
class ServiceStateList {
  ...
  ServiceStateList.fromJson(Map<String, dynamic> json) {
...
class ServiceListDef {
  ServiceInfo serviceInfo;
  CustomerInfo customerInfo;
  ServiceStateList serviceStateInfo;
  ServiceDetail serviceDetail;
  List<Null> serviceProductList;
  List<ServiceRelevantProductList> serviceRelevantProductList;
  List<Null> serviceStockList;
  List<Null> servicePhotoList;
  Null serviceNewRelaventPersonalName;
  ...
  ServiceListDef.fromJson(Map<String, dynamic> json) {
    ...
    serviceStateInfo = json['ServiceStateInfo'] != null
        ? new ServiceStateList.fromJson(json['ServiceStateInfo'])
        : null;
...
class CustomerInfo {
  ...
  String lat;
  String lng;
  List<CustomerDeviceListDefs> customerDeviceList;
  ...
  CustomerInfo.fromJson(Map<String, dynamic> json) {
    ...
    if (json['CustomerDeviceList'] != null) {
      customerDeviceList = new List<CustomerDeviceListDefs>();
      json['CustomerDeviceList'].forEach((v) {
        customerDeviceList.add(new CustomerDeviceListDefs.fromJson(v));
      });
    }
...
class CustomerDeviceListDefs {
  ...
  CustomerDeviceListDefs.fromJson(Map<String, dynamic> json) {
